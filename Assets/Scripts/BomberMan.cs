...
public class BomberMan : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (selectedCharacter != null && selectedCharacter.bomberManAnimator != null)
        {
            animator.runtimeAnimatorController = selectedCharacter.bomberManAnimator;
        }
        else
        {
            Debug.LogError("SelectedCharacter is null or animator controller is missing.");
        }
    ...
    {
        HasDetonator = true;
        Invoke("TurnOffDetonator", 30f);
    }

    void TurnOffDetonator()
    {
        HasDetonator = false;
    }
    ...
    {
        NoclipWalls = true;
        Invoke("TurnOffNoclipWalls", 30f);
    }

    void TurnOffNoclipWalls()
    {
        NoclipWalls = false;
    }
    ...
    {
        NoclipBombs = true;
        Invoke("TurnOffNoclipFire", 30f);
    }

    void TurnOffNoclipBombs()
    {
        NoclipBombs = false;
    }
    ...
    public void SetCharacterSprite(Sprite newSprite)
    {
        if (newSprite != null)
        {
            ...
            Debug.Log("Character sprite updated.");
        }
        else
        {
    ...
    public void UpdateCharacterSprite()
    {
        ...
        {
            Debug.Log("Updating character sprite from SelectedCharacter.");
            SetCharacterSprite(selectedCharacter.characterSprite);
        }
        else
        {
            Debug.LogError("selectedCharacter is null.");
        }
